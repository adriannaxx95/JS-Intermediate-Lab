...
const user = {
    ...
    const apple = {
        ...
        const billion1 = 1000000000 // 9 zeros - hard to
read
const billion2 = 1_000_000_000 // easier to
read, underscores ignored
const billion3 = 1e9 // exponential format
console.log(billion1 === billion2) // true
console.log(billion2 === billion3) // true

const microSecs1 = 0.000001 // 6 decimal places -
hard to read
...
console.log(`#${ff.toString(16)}${ee.toString(1
6)}${dd.toString(16)}`) // #ffeedd
...
// Numeric literals with absolute values equal to 2^53 or greater are too large to be
represented accurately as integers.
...
● Concat creates a new array including values from other arrays and additional
items. It accepts any number of arguments: either arrays or values.
const array1 = [1,2,3]
const array2 = [4,5,6]
const array3 = [7,8,9]
...
const student = {
    ...
    const book = {
        ...
        const room = {
            ...
            console.log( JSON.stringify(meetup, ['title', 'participants']) ); // just stringify the
properties in the array: {"title":"Strategy Conference","participants":["Chris","Tina"]}
